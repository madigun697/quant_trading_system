...
def build_router(
    ...
    async def run_backtest(request: Request) -> HTMLResponse:
        ...
        status_code = 200 if context.state != "error" else 400
        return templates.TemplateResponse(request, "backtest/index.html", context.model_dump(), status_code=status_code)
